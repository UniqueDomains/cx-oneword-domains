...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C314%20rows-8250df">
...
**Public extract:** 8,314 rows · **Live catalog:** 8,310 domains
...
- `cx.csv` — public CSV extract (8,314 rows)
- `cx.json` — public JSON extract (8,314 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,314-row public sample | 8,310 live domains                               |
...
> Unique Domains. *Available .CX One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
